"""
CatGPT 0.2 [DGM-Agent] 2024 - OpenRouter Edition (Updated for AutoGPT-like Behavior & Self-Modification)
REFACTORED VERSION - Patched by Gemini
- Improved system prompt for better DGM-style reasoning.
- Fixed inefficient UI update loop to reduce CPU usage.
- Hardened file operations to use a dedicated workspace, preventing unintended file access.
- Enhanced shutdown sequence for greater stability.
- Improved error handling in the main agent loop.
"""
